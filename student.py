...
from turtle import st, update, width
...
class Student:
    def __init__(self,root):
       ...
       title_lbl=Label(bg_img,text="STUDENT DETAILS MANAGEMENT",font=("times new roman", 35,"bold"),bg="white",fg="green")
       ...
       dep_combo["values"]=("Select Department","Computer","IT","Mech","Chemical")
       dep_combo.current(0)
       ...
       class_student_frame.place(x=5,y=250,width=680,height=300)
       ...
       btn_frame.place(x=0,y=205,width=680,height=30)

       #save button
       save_btn=Button(btn_frame,text="Save",command=self.add_data,width=15,font=("times new roman",16,"bold"),bg="white",fg="blue")
       save_btn.grid(row=0,column=0)
       
       #update
       update_btn=Button(btn_frame,text="Update",command=self.update_data,width=15,font=("times new roman",16,"bold"),bg="white",fg="blue")
       update_btn.grid(row=0,column=1)

       #delete
       delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=15,font=("times new roman",16,"bold"),bg="white",fg="blue")
       ...
       btn_frame1.place(x=0,y=240,width=680,height=30)


       #takephoto
       take_photo_btn=Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=35,font=("times new roman",16,"bold"),bg="white",fg="blue")
       take_photo_btn.grid(row=0,column=0)

       #updatephoto
       update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=35,font=("times new roman",16,"bold"),bg="white",fg="blue")
       ...
       #save button
       search_btn=Button(search_frame,command=self.search_data,text="Search",width=14,font=("times new roman",15,"bold"),bg="white",fg="red")
       search_btn.grid(row=0,column=3,padx=4)
       
       #update
       showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=14,font=("times new roman",15,"bold"),bg="white",fg="blue")
         ...
         messagebox.showerror("Error","All fields are required",parent=self.root)
            ...
            try:
                ...
                if Update>0:
                  conn=mysql.connector.connect(host="localhost",user="root",password="chocobar@6",database="facedb",port=3306)
                  my_cursor=conn.cursor()
                  my_cursor.execute("update student set Department=%s,Course=%s,Year=%s,Semester=%s,StudentId=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,DOB=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSampleStatus=%s where StudentId=%s",(
       ...
       if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
         messagebox.showerror("Error","Select Combo option and enter entry box",parent=self.root)
            ...
            try:
                  ...
                  my_cursor = conn.cursor()
                  sql = "SELECT StudentId,Name,Department,Course,Year,Semester,Division,Gender,DOB,Phone,Address,Roll,Email,Teacher,PhotoSampleStatus from student where Roll= "+str(self.var_search.get()) +" " 
